...
import { graphsDataII, Infos, reducer } from '../../../data/AiModelData'
...
const EnergyDemandPrediction = () => {
    const {demandPrediction,demandTestSet} = Infos();
    console.log(demandPrediction);
    ...
    const getDataAnd = (string) => {
        ...
        switch(string) {
            case 'energyPrediction':
                ...
                returnedObj.data = demandPrediction;
                break
            case 'energyTestSet' : 
                returnedObj.id = ids.testSetId;
                returnedObj.data = demandTestSet;  
                break;
        }
        return returnedObj;
    ...
    return (
        <div className="main--bank-ai-container">
            <h1> Future demand forecasting </h1>
            
             {graphsDataII.map((subarray, index) => {
                return (
                    <Row key={index}>
...
export default EnergyDemandPrediction;